...
vec2 v_texcoord; // texture coords
vec3 v_normal;   // normal
vec3 v_binormal; // binormal (for TBN basis calc)
vec3 v_pos;      // pixel view space position
...
void main() {
    ...
    vec3 albedo = pow(BlendMaps(vUv, vUv1, vUv2, vUv3, scale1, albedoMap, stuv1BaseColor, stuv2BaseColor, stuv3BaseColor, time), vec3(1.5));
